...
${i - 11 \choose i - 11}$ as the remaining ways to assign the respective coupons.
...
the exponential [Power Series](https://en.wikipedia.org/wiki/Power_series). As a reminder the power series is:
...
the $n$ taylor series expansions.
...
in the next section, we will be looking at how we can leverage Python to get
more concrete answers for some example cases.
